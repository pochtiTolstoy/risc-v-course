...
// Symbols for ram_delay section
extern const uint8_t __ram_delay_source_start;
extern uint8_t __ram_delay_target_start;
extern uint8_t __ram_delay_target_end;
...
extern void trap_handler(void) __attribute__((interrupt("machine"), section(".text.trap_handler")));
...
void _start(void) {
    ...
    // copy .ram_delay from rom to ram
    memcpy((void*)&__ram_delay_target_start, (const void*)&__ram_delay_source_start, (&__ram_delay_target_end - &__ram_delay_target_start));
